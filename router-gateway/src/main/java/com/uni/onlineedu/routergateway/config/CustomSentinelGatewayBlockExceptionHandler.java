...
public class CustomSentinelGatewayBlockExceptionHandler implements WebExceptionHandler {
    ...
    private Mono<Void> writeResponse(ServerResponse response, ServerWebExchange exchange) {
        ...
        ResponseData<Object> responseData = ResponseData.failure("当前访问人数过多，请稍后再试");
        DataBuffer wrap = serverHttpResponse.bufferFactory().wrap(JsonUtils.toJsonString(responseData).getBytes(StandardCharsets.UTF_8));
